...
$content []= new _p(
			new _ul( 
				array( new _li(  '<h3>Profiles</h3>'), new _li ('<a href="http://www.linkedin.com/in/ronaldob" title="Linkedin">Linked In</a>'), new _li('<a href="https://launchpad.net/~ronaldo-barbachano" title="Launchpad">Launchpad</a>'), new _li('<a href="https://github.com/redcap3000" title="github">Github</a>')  ),
				array('id'=>'profiles')
