...
$content []= new _h3('Profiles');
$content []= new _p(new _ul( array( new _li ('<a href="http://www.linkedin.com/in/ronaldob" title="Linkedin">Linked In</a>'), new _li('<a href="https://launchpad.net/~ronaldo-barbachano" title="Launchpad">Launchpad</a>'), new _li('<a href="https://github.com/redcap3000" title="github">Github</a>')  )));
